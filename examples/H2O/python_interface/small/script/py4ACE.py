...
Main.include("/home/c/chenqian3/ACEhamiltonians/H2O_PASHA/H2O_Pasha/data_interface/debug_mono/function.jl")
...
#######################################################################################################
ts = time.time()
predicted = Main.predictpp([water]*28, model)
ti = time.time()
print(f"time to predict is {ti-ts} second.")

predicted = [h for h in predicted] 
np.save("/home/c/chenqian3/ACEhamiltonians/H2O_PASHA/H2O_Pasha/data_interface/debug_mono/predicted.npy", predicted)
